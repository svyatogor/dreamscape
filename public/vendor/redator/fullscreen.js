	...
	$.Redactor.prototype.fullscreen = function()
	{
		return {
			...
			disable: function()
			{
				...
				this.core.box().removeClass('redactor-box-fullscreen').css({ width: 'auto', height: 'auto', left: 'auto', top: 'auto' });
			...
			resize: function()
			{
				...
				this.core.box().width('80vw').height('80vh').css('left', '10vw').css('top', '10vh');
